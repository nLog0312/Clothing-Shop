	...
	<div class="modal-container--detailProduct">
			<div class="modal-header">
				...
				<div class="modal-close">
					<a href="../ProductsManage/detail_product.php?id=<?php echo "$id";?>">
						<i class="bx bx-x"></i>
					</a>
				</div>
			</div>
			...
			<div class="modal-body--detailProduct">
				<form action="process_insert_detail.php?id=<?php echo "$id";?>" method="post" enctype="multipart/form-data">
					<label for="colorProduct">1. Nhập màu sắc sản phẩm: </label>
					<br>
					<input type="text" name="colorProduct" placeholder="Màu...">
				...
				<button>
					<a href="../ProductsManage/detail_product.php?id=<?php echo "$id";?>">Quay lại</a>
				</button>
			</div>
		</div>
	</div>
